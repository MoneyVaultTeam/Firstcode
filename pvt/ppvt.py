...
def button(update,context):
    ...
    if a== '1':
        ...
        reply_markup = InlineKeyboardMarkup(keyboard,resize_keyboard=True)
        context.bot.send_message(chat_id=update.effective_user.id,text='Send product detials',reply_markup=reply_markup)
        return UOL
    elif a== '916':
            keyboard =[[InlineKeyboardButton("🔙 Back", callback_data="100")]]
        ...
        cursor = conn.execute("SELECT name,productID from COMPANY")
        conn.commit()
        keyf=[]
        for row in cursor:
        ...
        context.bot.send_message(chat_id=update.effective_user.id,text="Select the Product to delete",reply_markup=reply_markup)  
        return DELC
    elif a=='99':
...
def uol(update,context):
    ...
    try:
        ...
        keyboard =[[InlineKeyboardButton("🔙 Back", callback_data="100")]]
        reply_markup = InlineKeyboardMarkup(keyboard,resize_keyboard=True)
        context.bot.send_message(chat_id=update.effective_user.id,text='Wrong Format.Send product detials',reply_markup=reply_markup)
        return UOL
